...
class ReactComp extends Component {
  ...
  constructor(props) {
    ...
    const top = (nowHour * oneMinuteHeight * 60) + (oneMinuteHeight * nowMinute) + cellHeight * 2;
    this.heights=[];
  ...
  componentDidMount() {
    setTimeout(() => this.list.scrollToOffset({offset: this.scrollPosition, animated: true}), 500);
  }
